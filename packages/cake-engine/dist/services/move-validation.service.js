...
export class MoveValidationService {
    ...
    validateCaptureMove(game, piece, from, to, path, availableCaptures) {
        ...
        const move = new Move(this.generateMoveId(), game.id, moveNumber, piece.color, from, to, matchingCapture.capturedSquares, matchingCapture.isPromotion, notation);
    ...
    validateSimpleMove(game, piece, from, to) {
        ...
        const move = new Move(this.generateMoveId(), game.id, moveNumber, piece.color, from, to, [], isPromotion, notation);
        // Apply the move
