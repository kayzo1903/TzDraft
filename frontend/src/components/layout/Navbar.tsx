    ...
    return (
        <nav
            className={clsx(
                ...
                isScrolled
                    ? 'border-b border-white/5 bg-[rgb(28_25_23/0.92)] backdrop-blur-md supports-[backdrop-filter]:bg-[rgb(28_25_23/0.78)] shadow-[0_12px_40px_rgba(0,0,0,0.35)]'
                    : 'border-b border-white/5 bg-[rgb(28_25_23/0.75)] backdrop-blur-md'
            )}
        >
