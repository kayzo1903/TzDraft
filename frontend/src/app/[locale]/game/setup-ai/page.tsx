        ...
        <div className="min-h-screen bg-[var(--background)] flex flex-col items-center justify-center p-6 text-foreground">
            <div className="max-w-4xl w-full space-y-8">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-muted-foreground">Choose your opponent and color</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Bot Selection */}
                    <div className="space-y-4">
                        <h2 className="text-xl font-semibold">Select Opponent</h2>
                        <div className="grid grid-cols-1 gap-3 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
                            {BOTS.map((bot) => (
                                <Card
                                    key={bot.level}
                                    className={`p-4 cursor-pointer transition-all hover:bg-neutral-800 border-2 flex items-center gap-4 ${selectedBot.level === bot.level
                    ...
                    {/* Right Column: Time, Color, Preview */}
                    <div className="space-y-8 flex flex-col h-full">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <button
                                    ...
                                    className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${selectedColor === "WHITE"
                                        ? "border-orange-500 bg-neutral-800"
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${selectedColor === "RANDOM"
                                        ? "border-orange-500 bg-neutral-800"
                                        : "border-neutral-700 bg-neutral-900 hover:bg-neutral-800"
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-xl border-2 transition-all flex flex-col items-center gap-2 ${selectedColor === "BLACK"
                                        ? "border-orange-500 bg-neutral-800"
                                        : "border-neutral-700 bg-neutral-900 hover:bg-neutral-800"
                                        }`}
                                >
                        ...
                        <div className="flex-1 bg-neutral-900 rounded-xl p-6 border border-neutral-800 flex flex-col items-center justify-center text-center gap-4 min-h-[200px]">
                            <div className="text-muted-foreground uppercase text-xs tracking-wider font-bold">Match Preview</div>
                            <div className="flex items-center gap-8">
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    <div className="text-xs text-muted-foreground">
                                        {typeof user?.rating === 'object' ? (user.rating as any).rating : (user?.rating || 1200)}
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    <div className="text-xs text-muted-foreground">{selectedBot.elo}</div>
                                </div>
                            </div>
