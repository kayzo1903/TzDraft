    ...
    <main className="min-h-screen bg-[var(--background)] text-[var(--foreground)] flex flex-col items-center py-12 px-4 md:px-8">
      <div className="max-w-4xl w-full space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-[#999999] max-w-2xl mx-auto">{t("subtitle")}</p>
        </div>

        <div className="space-y-6">
          <h2 className="text-2xl font-bold border-b border-[var(--secondary)] pb-2">
            {t("faq")}
          </h2>
        ...
        <div className="bg-[var(--secondary)]/20 p-6 md:p-8 rounded-xl shadow-xl border border-[var(--secondary)]">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <select
                name="subject"
                className="w-full px-4 py-3 bg-[var(--secondary)] border border-transparent rounded-lg focus:border-[var(--primary)] focus:ring-2 focus:ring-[var(--primary)]/50 text-white outline-none transition-all appearance-none cursor-pointer"
              >
