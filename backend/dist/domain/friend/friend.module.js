...
const friendly_match_service_1 = require("./friendly-match.service");
...
exports.FriendModule = FriendModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [friend_service_1.FriendService, friendly_match_service_1.FriendlyMatchService],
        exports: [friend_service_1.FriendService, friendly_match_service_1.FriendlyMatchService],
    })
], FriendModule);
